<%-- 
    ...
    Created on : May 27, 2021, 5:05:08 PM
    Author     : dell
--%>
                     ...
                     <div class="col-md-3">
                         <img src="profilepics/<jsp:expression>profile_pic</jsp:expression>" style="height: 80px">
                          ...
                          <div class="col-md-9 mt-3" style="text-align: centre">
                              ...
                              <h3 style="color: black">Upload Resume!</h3> <br>
                              <form method="post" action="editresume" enctype="multipart/form-data">
                              ...
                              <input type="submit" value="upload resume" class="btn btn-primary"> <br> <br>
                              </form>
